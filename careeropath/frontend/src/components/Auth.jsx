...
//           <h2 className="text-2xl font-semibold text-gray-900">Welcome to CareerPath</h2>
//           <p className="text-gray-600 mt-2">Sign in to discover your ideal tech career</p>
//         </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 p-4">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-lg border border-gray-100">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-semibold text-gray-900 mb-2">Welcome to CareerPath</h2>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500">
            No password required. Secure Google authentication.
          </p>
        </div>
      </div>
    </div>
